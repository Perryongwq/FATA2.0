...
const Filters = () => {
  ...
  return (
    <div className='w-full h-12 border-2 broder-gray-100 rounded-lg flex items-center justify-between relative
    '>
        <Search/>
        <div className='flex mr-7'>
          <form className='relative flex items-center font-nunito mr-12' onSubmit={handleCurrencySubmit}>
            ...
            <input type ="text" name='currency' ref={currencyRef} placeholder='usd' className='w-16 rounded bg-gray-200 placeholder:text-gray-100 required outline-0 border border-transparent
