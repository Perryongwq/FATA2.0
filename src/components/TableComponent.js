...
const TableComponent = () => {
    ...
    return (
                ...
                <table className='w-full table-auto'>
                    ...
                    cryptoData.map(data =>{
                            ...
                            <tr key={data.id} className='text-center text-base border-b border-gray-100 hover:bg-gray-200 last:border-b-0'>
                                <td className='py-4 flex items-center uppercase'>{data.asset}
                                ...
                                <td className='py-4'>{Number(data.market_cap_change_percentage_24h).toFixed(3)}%</td>
                                <td className={
        ...
        <span>Data Provided by <a className='text-cyan' href="http://www.coingecko.com" rel="nonreferrer" target={"_blank"}>CoinGecko</a></span>
            <Pagination/>
        </div>
